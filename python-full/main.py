...
Recursion works by breaking down a problem into smaller similar problems until it reaches a simple base case Each "layer" of recursion waits for the next one to finish until the base case is reached     
